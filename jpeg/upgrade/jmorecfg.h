...
/* Typedef for multiplying quantized coefficients by pre-IDCT multipliers.
 * Must be a signed type.  Use short if short*short is faster than int*int.
 */

#if BITS_IN_JSAMPLE == 8
typedef int MULTIPLIER;		/* may want short on some machines */
#else
typedef INT32 MULTIPLIER;	/* need more than 16 bits in this case */
#endif
